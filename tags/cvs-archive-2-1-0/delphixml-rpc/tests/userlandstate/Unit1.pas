...
{*******************************************************}
{
  $Header: d:\Archive\DeltaCopy\Backup\delphixml-rpc.cvs.sourceforge.net/delphixml-rpc/tests/userlandstate/Unit1.pas,v 1.1.1.1 2003-11-19 22:12:24 iwache Exp $
  ----------------------------------------------------------------------------
...
begin
  ...
  caller.HostName := 'betty.userland.com';
  caller.HostPort := 80;

  func := TFunction.Create;
  func.ObjectMethod := 'examples.getStateName';
  func.AddParam(42);
  ...
  if (rslt.IsError) then
    ...
    begin
      ...
      memo1.Lines.Add('value:' + rslt.GetString);
    end;
  func.Free;
  rslt.Free;
  caller.Free;
